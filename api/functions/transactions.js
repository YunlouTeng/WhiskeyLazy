...
try {
  ...
  console.log('Transactions.js: Successfully initialized Plaid client');
} catch (error) {
  console.error('Transactions.js: Error initializing Plaid client:', error);
  // Use mock client as fallback
  plaidClient = new plaid.PlaidApi();
  console.log('Transactions.js: Using mock Plaid client as fallback');
}
